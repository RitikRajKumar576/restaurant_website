...
$sql = "SELECT * FROM anniversary Where status=1";
...
<head>
    <title>View anniversary Bookings</title>
...
<body>
    ...
    <center><h1>Anniversary Bookings</h1></center>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><button class="btn btn-sm btn-success editbutton"
                                            ...
                                            <a href="action.php?delid='<?php echo $vl['id']?>'&delanni=delanni"
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <form method="POST" action="action.php" enctype="multipart/form-data">
                        ...
                        <button type="submit" name="update_anniversary" value="update_anniversary" class="btn btn-primary"><span
