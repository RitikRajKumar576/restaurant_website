...
$sql = "SELECT * FROM bachelor Where status=1";
...
<head>
    <title>View Bachelor's Bookings</title>
...
<body>
    ...
    <center><h1>Bachelor's Party Bookings</h1></center>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><button class="btn btn-sm btn-success editbutton"
                                            ...
                                            <a href="action.php?delid='<?php echo $vl['id']?>'&delbachelor=delbachelor"
                ...
                <div class="modal-body">
                    ...
                    <form method="POST" action="action.php" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input type="Y-m-d" name="date" class="form-control" id="date_m">
                        </div>
                        ...
                        <button type="submit" name="update_bachelor" value="update_bachelor" class="btn btn-primary"><span
